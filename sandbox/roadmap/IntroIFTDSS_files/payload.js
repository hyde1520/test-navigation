      ...
      if(responseJson.intents) {
        if(responseJson.intents.length >0){
          if (responseJson.intents[0].intent == 'zoom_to_ca'){
            postMessageToMap('geobot_zoomToCA');
          }
          if (responseJson.intents[0].intent == 'zoom_to_co'){
            postMessageToMap('geobot_zoomToCO');
          }
          if (responseJson.intents[0].intent == 'fires_size'){
            postMessageToMap('geobot_fires_size');
          }
          ...
          if (responseJson.intents[0].intent == 'fires_2015'){
            postMessageToMap('geobot_fires_2015');
          }
          if (responseJson.intents[0].intent == 'agency'){
            postMessageToMap('geobot_agency');
          }
          if (responseJson.intents[0].intent == 'landfire'){
            postMessageToMap('geobot_landfire');
          }
          if (responseJson.intents[0].intent == 'zoom_in'){
            postMessageToMap('geobot_zoom_in');
          }
 		  if (responseJson.intents[0].intent == 'zoom_out'){
            postMessageToMap('geobot_zoom_out');
          }
          if (responseJson.intents[0].intent == 'clear_map'){
            postMessageToMap('geobot_clear_map');
          }
          if (responseJson.intents[0].intent == 'cycle'){
            postMessageToApp('geobot_cycle');
          }
          if (responseJson.intents[0].intent == 'workspace'){
            postMessageToApp('geobot_workspace');
          }
          if (responseJson.intents[0].intent == 'home'){
            postMessageToApp('geobot_home');
          }
          if (responseJson.intents[0].intent == 'map'){
            postMessageToApp('geobot_map');
          }
          if (responseJson.intents[0].intent == 'yes_create_lcp'){
            postMessageToApp('geobot_create_lcp');
          }
           if (responseJson.intents[0].intent == 'create_lcp_help'){
            postMessageToApp('geobot_create_lcp_help');
          }
        }
      }
